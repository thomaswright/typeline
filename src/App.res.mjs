...
function xPosition(classification) {
...
function App(props) {
  ...
  return JsxRuntime.jsx("div", {
              children: typefaces.map(function (typeface) {
                    return JsxRuntime.jsx("div", {
                                children: JsxRuntime.jsx("img", {
                                      src: typeface.sampleImg,
                                      width: "100px"
                                    }),
                                className: "absolute border-2 border-black",
                                style: {
                                  left: Math.imul(xPosition(typeface.classification), 120).toString() + "px",
                                  top: Math.imul(2024 - typeface.released | 0, 10).toString() + "px"
                                }
                              });
                  }),
              className: "p-6"
